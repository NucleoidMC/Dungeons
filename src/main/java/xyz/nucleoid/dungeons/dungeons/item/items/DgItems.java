...
import xyz.nucleoid.dungeons.dungeons.item.weapon.melee.DgMaterialMeleeWeaponItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.melee.DgMetalMeleeWeaponItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.melee.DgMorningStarItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.ranged.DgMaterialBowItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.ranged.DgMaterialCrossbowItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.ranged.DgWoodBowItem;
import xyz.nucleoid.dungeons.dungeons.item.weapon.ranged.DgWoodCrossbowItem;
import xyz.nucleoid.dungeons.dungeons.item.material.DgMaterialComponent;
import xyz.nucleoid.dungeons.dungeons.item.material.DgQuarterstaffWood;
