package xyz.nucleoid.dungeons.dungeons.item.model;
...
public class DgItemModelRegistry {
    ...
    public static void register(Item real, Item proxy, String... modifiers) {
        ...
        Dungeons.LOGGER.debug("Registering model: " + modifiersString + " as proxy " + Registry.ITEM.getId(proxy) + " with id: " + IDS.getInt(modifiersString));
    }
